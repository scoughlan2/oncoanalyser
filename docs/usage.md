...
[here](https://github.com/nf-core/oncoanalyser/blob/0.5.0-dev+neosubworkflow/lib/Constants.groovy#L58-L90).
...
processes can be view [here](https://github.com/nf-core/oncoanalyser/blob/0.5.0-dev+neosubworkflow/lib/Constants.groovy#L36-L56)).
...
complete the prepared reference files can found in `./prepare_reference/reference_data/0.5.0-dev+neosubworkflow/<datetimestamp>/`. It is
